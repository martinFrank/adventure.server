...
import com.github.martinfrank.elitegames.adventureserver.server.game.GameController;
...
public class SecurityConfig {
    ...
    private List<String> allowedOrigins() {
        List<String> theList = Arrays.stream(allowedOrigins.split(",")).map(String::trim).toList();
        LOGGER.info("the list: {}", theList);
        return theList;
    }
}
